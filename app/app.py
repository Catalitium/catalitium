...
def create_app() -> Flask:
    ...
    def sitemap():
        ...
        _add(url_for("career_evaluate", _external=True), priority="0.7", changefreq="weekly")
        _add(url_for("career_ai_exposure", _external=True), priority="0.7", changefreq="weekly")
        _add(url_for("career_hiring_trends", _external=True), priority="0.7", changefreq="weekly")
        _add(url_for("career_earnings", _external=True), priority="0.7", changefreq="weekly")
        _add(url_for("career_paths", _external=True), priority="0.7", changefreq="weekly")
        _add(url_for("career_market_position", _external=True), priority="0.7", changefreq="weekly")
    ...
    # ------------------------------------------------------------------
    # Career Decision Intelligence (/career/ prefix)
    # ------------------------------------------------------------------

    @app.get("/career/evaluate")
    def career_evaluate():
    ...
    @app.get("/career/market-position")
