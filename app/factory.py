...
def create_app() -> Flask:
    ...
    if limiter is not None:
        for _ep, _rule in (
            ...
            ("carl_business.carl_business_analyze", "20 per minute"),
            ("carl_business.carl_business_chat", "40 per minute"),
            ("carl_business.carl_business_brave_context", "10 per minute"),
