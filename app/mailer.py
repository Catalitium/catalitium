"""All outbound email logic for Catalitium.

_send_mail is the only function that touches SMTP.
All other functions compose a body and delegate to _send_mail.
No SMTP code should exist outside this module.
"""
